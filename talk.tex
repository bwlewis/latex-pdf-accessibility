...
\item Open the installed TeXworks editor and select the LuaLaTeX engine from the dropdown (see figure below).
\end{enumerate}
...
\end{itemize}
\hspace{3em}\includegraphics[width=0.75\textwidth]{overleaf}
\end{minipage}
}
...
your PDF otuput through a reader like NVDA to make sure it works well.
...
\begin{minipage}{0.475\textwidth}
\begin{center}
\includegraphics[width=0.5\textwidth]{BryanLewis}\\
\end{center}
Bryan Lewis teaches math at Garrett College and has been using \LaTeX since
the mid 1990s. He's written dozens of journal papers, a book, many talks,
